    ...
    : AudioProcessorEditor (owner)
{
    ...
    otherLookAndFeel.setColour(Slider::backgroundColourId, Colour(248, 248, 248));
    otherLookAndFeel.setColour(Slider::trackColourId, Colour(248, 248, 248));
    otherLookAndFeel.setColour(Slider::rotarySliderFillColourId, Colour(164,164,164));
    otherLookAndFeel.setColour(Slider::rotarySliderOutlineColourId, Colour(248,248,248));
